  ...
  return (
    <div>
      ...
      <Breadcrumb>
          ...
          <Breadcrumb.Item active style={{color:'white'}}>Графический дизайн</Breadcrumb.Item>
        </Breadcrumb>
      <div class="line"></div>
        <h1 class="category_name" style={{color:'white'}}>{category.name}</h1>
          ...
          <div class="activities-block" style={{width:'100%', display:'flex', flexWrap:'wrap'}}>            
            <div class="activity-block">
              ...
              <Row style={{alignItems:'flex-end'}}>
                <Col lg={9}>
                  <p class="activity-description">Работы по созданию уникальных дизайнов для веб-сайтов. Разработка красивых макетов, которые не только привлекают внимание, но и обеспечивают удобство использования для пользователей. От простых х до более сложных и креативных концепций.</p>
                </Col>
                <Col lg={3}>
